    ...
    for pose_name in pose_options:
        for landmark in [1, 2]:
            ...
            if sum_of_marginals<best_sum_of_marginals:
                ...
                final_sum_of_marginals = marginals.marginalCovariance(L(1)).sum() + marginals.marginalCovariance(L(2)).sum()

    sum_of_marginals = final_sum_of_marginals
...
def minimize_errors(graph, initial_estimate, pose_options):
    ...
    sum_of_errors = best_sum_of_errors
